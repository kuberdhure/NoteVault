...
export default function Home() {
  ...
  return (
      <div>
          <div className='ml-5 mt-4'>
             <div className='flex flex-row justify-between'>
                 ...
                 <div className='flex flex-row gap-x-2 mr-10 items-center'>
                     ...
                     <Link href={'/books'}>
                         <Image src={'/right-arrow.png'} alt={"Arrow"} height={25} width={25}/>
                     </Link>
                 </div>
             </div>
          ...
          <div className='mt-4'>
              <p className='flex justify-center items-center text-2xl font-bold '>Browse By</p>
              <div className='flex flex-row justify-evenly mb-4 mt-4 flex-wrap'>
                  ...
                  <Browse browse_image={'/University.png'} browse_name={'Universities'} />
